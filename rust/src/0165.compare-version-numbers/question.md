...
**revisions** separated by dots `'.'`. The **value of the revision** is its **integer conversion**
...
version1's second revision is "2" and version2's second revision is "10": 2 < 10, so version1 <
version2.
